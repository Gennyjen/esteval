 ...
 */
class Version20180205105107 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE rubriques CHANGE id_theme id_theme INT NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE rubriques CHANGE id_theme id_theme VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
